...
from nets.m2det_training import MultiboxLoss, get_lr_scheduler
from utils.anchors import get_anchors
from utils.callbacks import (ExponentDecayScheduler, LossHistory,
                             ParallelModelCheckpoint)
from utils.dataloader import M2DETDatasets
...
if __name__ == "__main__":
    ...
    if True:
        ...
        train_dataloader    = M2DETDatasets(train_lines, input_shape, anchors, batch_size, num_classes, train = True)
        val_dataloader      = M2DETDatasets(val_lines, input_shape, anchors, batch_size, num_classes, train = False)
